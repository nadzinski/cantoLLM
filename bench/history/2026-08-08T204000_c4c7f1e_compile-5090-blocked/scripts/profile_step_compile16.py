...
# ── Phase A ──────────────────────────────────────────────────────────
config48 = BatchingConfig(max_batch=16, max_seq_len=4096, max_tokens_per_step=256,
                         **default_shape_buckets(16, 256),
                         warmup_shapes=True, torch_compile=True, cuda_graphs=False)
